...
| `public/assets/pine-1.svg` through `public/assets/pine-4.svg` | Lightweight original pine illustrations used sparingly around the visitor-path trail. They replace the busier woodland background image and keep the path closer to the approved sketch direction. |
