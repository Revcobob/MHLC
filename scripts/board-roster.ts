/*
 * Canonical foundation roster — the source of truth shared by the seed
 * (scripts/seed-board.ts) and the photo backfill (scripts/backfill-board-photos.ts).
 *
 * Portraits are committed static assets under public/assets, served at
 * /assets/board-<slug>-web.jpg. `image` on each entry is that slug.
 */

export interface Seed {
  name: string; title: string; category: 'officers' | 'board' | 'staff';
  bio: string;
  // Slug of the committed portrait in public/assets/board-<slug>-web.jpg.
  image: string;
}

export const ROSTER: Seed[] = [
  // Officers
  { name: 'Debbie Robinson', title: 'President', category: 'officers', image: 'robinson',
  ...
  { name: 'Orval Lindsey', title: 'Vice President', category: 'officers', image: 'lindsey',
  ...
  { name: 'Annette Simpkins', title: 'Secretary', category: 'officers', image: 'simpkins',
  ...
  // Board members
  { name: 'Randy Dunn', title: 'Board Member', category: 'board', image: 'dunn',
  ...
  { name: 'Brenda Hunter', title: 'Board Member', category: 'board', image: 'hunter',
  ...
  { name: 'Larry F. Bowman', title: 'Board Member', category: 'board', image: 'bowman',
  ...
  { name: 'Pepper Aasgaard', title: 'Board Member', category: 'board', image: 'aasgaard',
  ...
  { name: 'Dr. Rickey Cameron', title: 'Board Member', category: 'board', image: 'cameron',
  ...
  { name: 'Tom Keenan', title: 'Board Member', category: 'board', image: 'keenan',
  ...
  { name: 'Craig Lindholm', title: 'Board Member', category: 'board', image: 'lindholm',
  ...
  // Staff & advisors
  { name: 'Claudia Herber Pair', title: 'Administration Assistant', category: 'staff', image: 'pair',
  ...
  { name: 'Darrell Slabaugh', title: 'Advisor', category: 'staff', image: 'slabaugh',
...
// Portrait URL + alt text derived from a roster entry.
export function portraitUrl(image: string): string {
  return `/assets/board-${image}-web.jpg`;
}
